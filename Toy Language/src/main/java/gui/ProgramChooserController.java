...
public class ProgramChooserController {
    ...
    private ObservableList<IStatement> getAllStatements() {
        ...
        IStatement ex12 = new CompoundStatement(new VariableDeclarationStatement("a", new IntType()),
                new CompoundStatement(new VariableDeclarationStatement("b",new IntType()),
        ...
        new CompoundStatement(new SwitchStatement(new ArithmeticExpression('*', new ValueExpression(new IntValue(10)), new VariableExpression("a")),
                new ArithmeticExpression('*', new VariableExpression("b"), new VariableExpression("c")),
                new CompoundStatement(new PrintStatement(new VariableExpression("a")), new PrintStatement(new VariableExpression("b"))),new ValueExpression(new IntValue(10)),
